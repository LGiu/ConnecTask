...
public class DetalhesTarefaAtiva extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Progress progress = new Progress(DetalhesTarefaAtiva.this, false);
        ...
        Preferencias preferencias = new Preferencias(DetalhesTarefaAtiva.this);
        ...
        if(idTarefa != null && (status.equals("1"))){
                        ...
                        if(id.equals(idTarefa)){
                            ...
                            firebase2.addValueEventListener(new ValueEventListener() {
                                ...
                                public void onDataChange(DataSnapshot dataSnapshot) {
                                    for (DataSnapshot dados: dataSnapshot.getChildren()) {
                                        ...
                                        if(identificadorUsuarioLogado.toString().equals(codificarBase64(usuario.getEmail().toString()))){
                            ...
                            buttonExcluir.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View view) {
                                    new AlertDialog.Builder(DetalhesTarefaAtiva.this)
                                            ...
                                            .setPositiveButton("Sim",
                                                    new DialogInterface.OnClickListener() {
                                                        ...
                                                        public void onClick(DialogInterface dialogInterface, int i) {
                                                            firebase1.child(idTarefa).child("status").setValue("3");

                                                            Intent intent = new Intent(DetalhesTarefaAtiva.this, MinhasTarefasAtivas.class);
            ...
            textViewNome.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    paginaUsuario.setContext(DetalhesTarefaAtiva.this);
            ...
            Intent in = new Intent(DetalhesTarefaAtiva.this, Home.class);
            startActivity(in);
